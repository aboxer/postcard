    ...
    def parse(self, addr_str, skip_house=False):
        ...
        for i in range(start_idx, len(tokens)):
            ...
            if word_lw in self.street_type_set and len(street_accum) > 0:
                if res['street_type']:      #[ab-111719] Bug fix - if part of street name matches street_type it is overwritten by next street_type
                  street_accum.append(res['street_type']) #append it to street before overwriting
